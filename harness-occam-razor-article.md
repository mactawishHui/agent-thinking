...
第五，每轮结束要做复杂度审查。不是只看测试绿不绿，还要看改动是否变简单了。如果功能完成了，但系统复杂度大幅上升，那这一轮不应该轻易通过。
